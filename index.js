...
function countVowelsAndConsonants(word) {
  ...
  for (const char of word) {
    if (allVowels.includes(char.toLowerCase())) {
      console.count("Amount of vowels");
    } else if (char !== "!") {
      console.count("Amount of consonants");
    }
  }
  console.countReset("Amount of vowels");
  console.countReset("Amount of consonants");
}
